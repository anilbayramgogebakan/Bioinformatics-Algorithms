...
def global_allignment(text,pattern, match, mismatch, gap, output_file):
    ...
    print(res_pattern)
    print(res_text)
    print("Score = {}".format(int(score_ar[-1][-1])))
...
# global_allignment(text, pattern, match, mismatch, gap, "global.txt")